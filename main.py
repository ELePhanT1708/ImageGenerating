...
def create_card(book_image_path: str, main_title: str, type_of_book: str, class_info: str, output_path: str):
    #  BACKGROUND
    width = 1200
    height = 1600
    ...
    draw.text((800, 500), "класс", font=font_class_text, align='center', anchor='mm')
...
if __name__ == "__main__":
    ...
    class_info = '2'
    create_card(book_image_path, main_title, type_of_book, class_info, output_path)
    df = read_excel(excel_path)
    for book_path, main_title, type_of_book, class_info, output_path in zip(
            df['book_path'],
            df['main_title'],
            df['type_of_book'],
            df['class_info'],
        ...
        create_card(book_path, main_title, type_of_book, class_info, output_path)
    ### Text
